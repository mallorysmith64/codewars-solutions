// Level: 6kyu
// Name: Dubstep
// Instructions: Polycarpus works as a DJ in the best Berland nightclub, and he often uses dubstep music in his performance. Recently, he has decided to take a couple of old songs and make dubstep remixes from them.
...
//Solution 1 in Javascript using Regex:
const songDecoder = song => {
  let original_song = song.replace(/(WUB)+/g, " ");
